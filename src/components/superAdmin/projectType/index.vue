<template>
  <div class="tpl-content-wrapper">
    <!--内部头部-->
    <wrapheader Title="项目类型管理" Name="uconnect" Title_sec="项目类型管理"></wrapheader>
    <!--内部头部结束-->
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
          <div class="widget am-cf" >
            ...
            <div class="widget-head am-cf" >
              <div class="widget-title am-fl" >项目类型管理</div>
              <div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        set_projectType: ({projectType}) => projectType.set_projectType,
...
//          console.log(val,'project_type数据来了');
          this.form = this.set_projectType
        },
        deep: true
      },
      devicetypes:{
...
//          console.log(val,'project_type数据来了');
    ...
    methods: {
      ...
      handleEdit(index, row) {
        this.get_projectType_info(row._id)
        this.editid = row._id
        this.form_title = '编辑项目类型'
        this.dialogFormVisible = true
      ...
      submitForm(formName){
        this.$refs[formName].validate((valid) => {
          console.log(valid)
          if (valid) {
            if(this.form_title === '添加项目类型'){
              this.add_projectType(this.form)
            }else{
              var data = {
                obj: this.form,
                id: this.editid
              }
              this.update_projectType(data)
            }
