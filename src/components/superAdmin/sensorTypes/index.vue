<template>
  <div class="tpl-content-wrapper">
    <!--内部头部-->
    <wrapheader Title="传感器类型管理" Name="uconnect" Title_sec="传感器类型管理"></wrapheader>
    <!--内部头部结束-->
    <!--内部warper-->
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
          <div class="widget am-cf">
            ...
            <div class="widget-head am-cf">
              <div class="widget-title am-fl">传感器类型管理</div>
              <div>
            ...
            <div class="widget-body  widget-body-lg am-fr" style="height: 100%; " id="form-body">
              <template>
                <el-table :data="allSensorType.data" stripe style="width: 100%">
                  ...
                  <el-table-column prop="unit_mark" label="单位" width="180">
                  </el-table-column>
                  <el-table-column prop="typeNum" label="传感器编码" width="180">
                  </el-table-column>
    ...
    <el-dialog :title="form_title" :modal=true size="tiny" :visible.sync="dialogFormVisible">
      <el-form :model="form" label-position="left" ref="form" :rules="rules">
        ...
        <el-form-item label="数据类型" :label-width="formLabelWidth" prop="data_type">
          <el-select v-model="form.data_type" placeholder="请选择" style="width: 100%">
            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="单位" :label-width="formLabelWidth" prop="unit_mark">
          <el-input v-model="form.unit_mark" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="传感器编码" :label-width="formLabelWidth" prop="typeNum">
...
export default {
  ...
  watch: {
    sensorType: {
      handler: function(val, oldVal) {
        this.form = this.sensorType.data
      },
      deep: true
    },
  ...
  methods: {
    ...
    handleEdit(index, row) {
      this.getSensorTypeInfo(row._id)
      this.editid = row._id
      this.form_title = '编辑传感器类型'
      this.dialogFormVisible = true
    ...
    submitForm(formName) {
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          if (this.form_title === '添加传感器类型') {
            await this.addSensorType(this.form)
          } else {
